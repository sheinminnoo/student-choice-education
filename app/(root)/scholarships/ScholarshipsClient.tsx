      ...
      <section className={`${MAX_WIDTH} space-y-8 py-8 sm:py-10 lg:py-12`}>
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* Row 2: Countries (Full Width to fix spacing) */}
            <div>
            ...
            {/* Row 3: Dropdowns and Toggle (Unified 3-column Grid) */}
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              {/* Automatic toggle - Removed 'mt-5' to fix vertical alignment */}
              <button
                type="button"
                onClick={() => {
                  setAutoOnly((v) => !v);
                ...
                className={`flex w-full items-center justify-between rounded-2xl border px-3.5 py-2.5 text-xs font-medium transition ${
                  autoOnly
                    ? "border-yellow-400 text-[#020b2c] bg-yellow-50"
                    : "border-slate-200 text-slate-700 bg-white hover:border-yellow-400"
                }`}
              >
                <span>Automatic scholarships</span>
                <span
